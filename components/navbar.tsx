...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-1/2 z-50 w-full max-w-6xl -translate-x-1/2">
      ...
      {/* Mobile menu */}
      {open && (
        <div className="mt-0 rounded-2xl border border-white/40 bg-white/40 backdrop-blur-xl shadow-xl md:hidden">
