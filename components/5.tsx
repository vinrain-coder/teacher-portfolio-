    ...
    <Section id="experience" title="Teaching Experience">
      <div className="space-y-6 max-w-3xl">
        <div className="flex gap-4">
          <Briefcase className="h-6 w-6 text-green-700 mt-1" />
          <div>
            ...
            <ul className="mt-3 list-disc pl-5 space-y-1 text-muted-foreground">
              <li>Teaching Integrated Science, Biology & Agriculture (Grade 7–9)</li>
              <li>Designing CBC-aligned lesson plans and assessments</li>
